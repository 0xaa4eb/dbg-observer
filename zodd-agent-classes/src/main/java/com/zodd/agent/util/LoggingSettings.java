...
public class LoggingSettings {
    ...
    public static final String LOG_LEVEL_PROPERTY = "zodd.org.slf4j.simpleLogger.defaultLogLevel";
    public static final String SHOW_DATETIME_PROPERTY = "zodd.org.slf4j.simpleLogger.showDateTime";
    ...
    static {
        ...
        if (defaultLogging) {
            logger.info("Zodd logging is enabled. One can disable it with {}", ("-D" + LOG_LEVEL_PROPERTY + "=OFF"));
        }
    ...
    public static String getLoggingLevel() {
        return System.getProperty("zodd.org.slf4j.simpleLogger.defaultLogLevel");
    }
}
